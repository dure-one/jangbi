...
# file operations, and system information gathering. It includes tools for IP address detection,
# website availability checking, random file operations, and various system utilities.
## 
## # Jangbi Configs
...
## Current configuration is stored in `/etc/network/`. it is generated by `net-ifupdown configgen` command on install.
