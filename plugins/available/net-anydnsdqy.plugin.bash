...
function __net-anydnsdqy_check { # running_status 0 installed, running_status 5 can install, running_status 10 can't install, 20 skip
    ...
    [[ -z ${RUN_ANYDNSDQY} ]] && \
        log_info "RUN_ANYDNSDQY variable is not set." && __net-anydnsdqy_disable && [[ $running_status -lt 20 ]] && running_status=20
    [[ ${RUN_ANYDNSDQY} != 1 ]] && \
        log_info "RUN_ANYDNSDQY is not enabled." && [[ $running_status -lt 10 ]] && running_status=10
